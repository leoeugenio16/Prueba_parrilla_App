...
export interface ApiDetalleProductoDetalleProducto
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detalles_de_pedido: Schema.Attribute.Relation<
      'manyToOne',
      'api::detalles-de-pedido.detalles-de-pedido'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::detalle-producto.detalle-producto'
    > &
      Schema.Attribute.Private;
...
export interface ApiDetallesDePedidoDetallesDePedido
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Detalle_de_pago: Schema.Attribute.Enumeration<
      ['Efectivo', 'QR', 'Transferencia', 'Tarjeta']
    >;
    detalle_productos: Schema.Attribute.Relation<
      'oneToMany',
      'api::detalle-producto.detalle-producto'
    >;
    ...
    >;
    hora_apertura: Schema.Attribute.DateTime;
    hora_cierre: Schema.Attribute.DateTime;
    id_pedido: Schema.Attribute.Relation<'oneToOne', 'api::pedido.pedido'>;
    id_productos: Schema.Attribute.Relation<
      'manyToMany',
    ...
    > &
      Schema.Attribute.Private;
    mesa: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    subtotal: Schema.Attribute.Integer;
    tiempo: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMesaMesa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::mesa.mesa'> &
      Schema.Attribute.Private;
    numero_mesa: Schema.Attribute.Integer;
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detalles_de_pedido: Schema.Attribute.Relation<
      ...
      'api::detalles-de-pedido.detalles-de-pedido'
    >;
    estado: Schema.Attribute.Enumeration<['abierto', 'cerrado']>;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detalle_productos: Schema.Attribute.Relation<
      ...
      'api::detalle-producto.detalle-producto'
    >;
    detalles_de_pedidos: Schema.Attribute.Relation<
      'manyToMany',
      'api::detalles-de-pedido.detalles-de-pedido'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::detalle-producto.detalle-producto': ApiDetalleProductoDetalleProducto;
      'api::detalles-de-pedido.detalles-de-pedido': ApiDetallesDePedidoDetallesDePedido;
